...
<form id="{slug}-form">
  ...
  -->
  <!-- Honeypot (if schema includes one): -->
  ...
  <div id="{slug}-success" style="display:none; color:green;">Submitted successfully!</div>
</form>
  ...
  try {
    ...
    if (res.ok) {
      ...
      if (body.error?.details) {
        ...
        errorsEl.textContent = body.error?.message || 'Something went wrong.';
      }
